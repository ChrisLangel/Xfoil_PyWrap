...
class xclass:
        ...
        """ A class that will act as a container for all the variables output from XFOIL. 
            Will compute derived quantities on initialization and 
            include method for computing integrated quanties """

	def __init__( self,mach,Rey,xu,yu,xl,yl,nu,nl,ueu,uel,rtu,rtl,
	                   cfu,cfl,cpu,cpl,thtu,thtl,dstu,dstl ):
		# Specify the speed of sound to extract dimensional quantities 
		a_0 = 340.29
		# 
		self.mach = mach
		self.Rey  = Rey 
	...
	def comp_ders( self,x,y ):
		dydx = [0.0] # Assume we start with a zero derivative 
