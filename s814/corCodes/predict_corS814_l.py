    ...
    for den in dens:
      ...
      # intitialize arrays for this particular Reynolds number
        ...
        for rht in rhts:
            ...
            subst   = ''.join(['L_',rstr, '_', rht, '_', den, '_' ])
            print subst
            ...
            for aoa in aoas:
                ...
                if not err:
                      ...
                      Ilambda = foo(0.14,0.025,np.array(quant2),1)**intPwr

                      # call function to pull transition location with Ilambda
                      roughTrans = pull_cor( Ilambda,m,b,thisclass.rtl,thisclass.xl )
