...
N6E3E140_15_Re_1_6E.plotpolar('o',color=[0.0,0.4,0.0], mec=[0.0,0.4,0.0],markersize=10, linewidth=2)
...
X_n63polar1_6_trip.plotpolar('--x',color=[0.8,0.0,0.0],mec=[0.8,0.0,0.0],mfc='none',mew=2,markersize=10, linewidth=2)
...
N6E3E140_15_Re_2_4E.plotpolar('o',color=[0.0,0.4,0.0], mec=[0.0,0.4,0.0], markersize=10, linewidth=2)
...
X_n63polar2_4_trip.plotpolar('--x',color=[0.8,0.0,0.2],mec=[0.8,0.0,0.0],mfc='none',mew=2,markersize=10, linewidth=2)
ax.set_yticklabels([])
plt.ylim([0,0.025])
plt.xlim([-0.5,1.5])
...
N6E3E140_15_Re_3_2E.plotpolar('o',color=[0.0,0.4,0.0], mec=[0.0,0.4,0.0], markersize=10, linewidth=2)
...
X_n63polar3_2_trip.plotpolar('--x',color=[0.8,0.0,0.0],mec=[0.8,0.0,0.0],mfc='none',mew=2,markersize=10, linewidth=2)
ax.set_yticklabels([])
plt.ylim([0,0.025])
plt.xlim([-0.5,1.5])
